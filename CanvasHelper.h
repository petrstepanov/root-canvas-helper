...
class CanvasHelper : public TObject {
  ...
  public:
    ...
    enum EPaveAlignBits {
        kPaveAlignLeft = BIT(14),
        kPaveAlignRight = BIT(15),
        kPaveAlignTop = BIT(16),
        kPaveAlignBottom = BIT(17)
    };
    ...
    // static const Double_t AXIS_TITLE_OFFSET;
...
//    static TGraph* findTGraphOnPad(TVirtualPad* pad);
    ...
    static std::pair<TAxis*,TAxis*> getXYAxis(TVirtualPad* pad);
